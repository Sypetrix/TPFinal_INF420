...
\begin{problem}{Recomendação Netflix}{netflix}{1}
...
Consideramos $N$ usuários e $T$ títulos. Cada usuário indica a preferência por cada um dos títulos. As preferências são valores inteiros de 0 e 9 que representam a nota do usuário para um título. A similaridade deve ser calculada como o número de preferências (notas) iguais entre $U$ e um outro usuário. Por exemplo, para $T = 2$, se um usuário fornece as notas 4 9 para os dois títulos e $U$ fornece as notas 4 8, a similaridade entre os dois é igual a 1. Se $U$ fornece as notas 3 8, a similaridade é igual a 0.
...
A primeira linha contém dois inteiros, $N$ e $T$, respectivamente o número de usuários e o número de títulos (portanto, de notas). Em seguida há $N$ linhas com $T$ inteiros cada, informando as preferências de cada usuário por cada título. Por fim, há mais uma linha, com as $T$ preferências do usuário $U$. Restrição: $1 \leq N, T \leq 100$.
